...
let Config = () => {
  ...
  const [
    styles_selection_paddingTop,
    setStyles_selection_paddingTop
  ] = useState(defaultProps.styles_selection_paddingTop);
  const [
    styles_selection_paddingBottom,
    setStyles_selection_paddingBottom
  ] = useState(defaultProps.styles_selection_paddingBottom);
  const [
    styles_selection_paddingLeft,
    setStyles_selection_paddingLeft
  ] = useState(defaultProps.styles_selection_paddingLeft);
  const [
    styles_selection_paddingRight,
    setStyles_selection_paddingRight
  ...
  const [
    styles_option_paddingBottom,
    setStyles_option_paddingBottom
  ...
  const [
    styles_checkRadio_borderWidth,
    setStyles_checkRadio_borderWidth
  ] = useState(defaultProps.styles_checkRadio_borderWidth);
  const [
    styles_checkRadio_marginBetween,
    setStyles_checkRadio_marginBetween
  ] = useState(defaultProps.styles_checkRadio_marginBetween);
  const [
    styles_checkRadio_labelMargin,
    setStyles_checkRadio_labelMargin
  ] = useState(defaultProps.styles_checkRadio_labelMargin);
  const [
    styles_checkRadio_paddingTop,
    setStyles_checkRadio_paddingTop
  ] = useState(defaultProps.styles_checkRadio_paddingTop);
  const [
    styles_checkRadio_paddingBottom,
    setStyles_checkRadio_paddingBottom
  ] = useState(defaultProps.styles_checkRadio_paddingBottom);
  const [
    styles_checkRadio_paddingLeft,
    setStyles_checkRadio_paddingLeft
  ] = useState(defaultProps.styles_checkRadio_paddingLeft);
  const [
    styles_checkRadio_paddingRight,
    setStyles_checkRadio_paddingRight
